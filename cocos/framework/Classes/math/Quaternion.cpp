...
namespace framework 
{
	namespace math
	{
		const Real Quaternion::ms_fEpsilon = Real_Epsilon;
		const Quaternion Quaternion::ZERO(Real_Zero,Real_Zero,Real_Zero,Real_Zero);
		const Quaternion Quaternion::IDENTITY(Real_One,Real_Zero,Real_Zero,Real_Zero);
		...
		void Quaternion::FromRotationMatrix (const Matrix3& kRot)
		{
			...
			else
			{
				...
				fRoot = Math::Sqrt(kRot[i][i]-kRot[j][j]-kRot[k][k] + Real_One);
				Real* apkQuat[3] = { &x, &y, &z };
				*apkQuat[i] = Real_Half*fRoot;
				fRoot = Real_Half/fRoot;
		...
		void Quaternion::ToRotationMatrix (Matrix3& kRot) const
		{
			...
			kRot[0][0] = Real_One-(fTyy+fTzz);
			kRot[0][1] = fTxy-fTwz;
			kRot[0][2] = fTxz+fTwy;
			kRot[1][0] = fTxy+fTwz;
			kRot[1][1] = Real_One-(fTxx+fTzz);
			kRot[1][2] = fTyz-fTwx;
			kRot[2][0] = fTxz-fTwy;
			kRot[2][1] = fTyz+fTwx;
			kRot[2][2] = Real_One-(fTxx+fTyy);
		}
		//-----------------------------------------------------------------------
			...
			const Vector3& rkAxis)
		{
			...
			Radian fHalfAngle ( Real_Half*rfAngle );
		...
		Vector3 Quaternion::xAxis(void) const
		{
			...
			return Vector3(Real_One-(fTyy+fTzz), fTxy+fTwz, fTxz-fTwy);
		}
		//-----------------------------------------------------------------------
		Vector3 Quaternion::yAxis(void) const
		{
			...
			return Vector3(fTxy-fTwz, Real_One-(fTxx+fTzz), fTyz+fTwx);
		}
		//-----------------------------------------------------------------------
		Vector3 Quaternion::zAxis(void) const
		{
			...
			return Vector3(fTxz+fTwy, fTyz-fTwx, Real_One-(fTxx+fTyy));
		}
		//-----------------------------------------------------------------------
			...
			const Quaternion& rkP, const Quaternion& rkQ, int iExtraSpins)
		{
			...
			Real fCoeff0 = Math::Sin((Real_One-fT)*fAngle - fPhase)*fInvSin;
		...
		{
			Real fSlerpT = Real_Two*fT*(Real_One-fT);
	...
	//			Real fTx  = Real_Two*x;
				...
				// Vector3(Real_One-(fTyy+fTzz), fTxy+fTwz, fTxz-fTwy);

				return Radian(Math::ATan2(fTxy+fTwz, Real_One-(fTyy+fTzz)));
	...
	//			Real fTy  = Real_Two*y;
				...
				// Vector3(fTxy-fTwz, Real_One-(fTxx+fTzz), fTyz+fTwx);
				return Radian(Math::ATan2(fTyz+fTwx, Real_One-(fTxx+fTzz)));
			}
			else
			{
				// internal version
		...
		Radian Quaternion::getYaw(bool reprojectAxis) const
		{
			if (reprojectAxis)
			{
				...
				// Vector3(fTxz+fTwy, fTyz-fTwx, Real_One-(fTxx+fTyy));

				return Radian(Math::ATan2(fTxz+fTwy, Real_One-(fTxx+fTyy)));
