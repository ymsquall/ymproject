function LUALoadSelectHeroView(viewWideh, viewHeight)
	...
	local pHeadImage2 = LUACreateUIImageView("picture/heroface/2160-1.png")
	local pHeadImage3 = LUACreateUIImageView("picture/heroface/2160-1.png")
	local pHeadImage4 = LUACreateUIImageView("picture/heroface/2160-1.png")
	local pHeadImage5 = LUACreateUIImageView("picture/heroface/2160-1.png")
	local pHeadImage6 = LUACreateUIImageView("picture/heroface/2160-1.png")

	local headSize = pHeadImage1:getContentSize()
	local pos = CCPoint(headSize.width/2.0 + 20, headSize.height/2.0)
