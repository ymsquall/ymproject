...
function LUATestStartPlayStruggleRecord()
	...
	block:write1(LiveActionType_moveto) actNum = actNum + 1 block:write1(3) block:write1(GridOrientation_righttop) block:write1(GridOrientation_righttop) block:write1(GridOrientation_righttop)
